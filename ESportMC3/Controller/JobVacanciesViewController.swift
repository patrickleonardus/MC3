...
class JobVacanciesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        segmentedControl.anchor(top: stackView.topAnchor, leading: stackView.leadingAnchor, bottom: tableView.topAnchor, trailing: stackView.trailingAnchor, padding: .init(top: 20, left: 20, bottom: 20, right: 0))
